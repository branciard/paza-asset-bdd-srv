...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pazaassetbddsrv@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pazaassetbddsrv API";

        private String description = "pazaassetbddsrv API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pazaassetbddsrv";
